// D-P2-06/07/08 contract for the strikethrough plugin. Marker: '~~' (matches the GFM
// strikethrough syntax the pipeline, 02-01/02-03, parses). Same toggle/wrap/empty-insert
// shape as bold.ts (02-03 tracer).
...
export const strikethrough: EditorPlugin = {
  id: "strikethrough",
