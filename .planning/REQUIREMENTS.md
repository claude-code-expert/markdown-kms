...
- [x] **EDIT-10** (P1, FR-E7): 툴바는 lucide 아이콘 + hover 300ms 내 툴팁 + 클릭 pressed 피드백을 갖는다
- [x] **EDIT-11** (P1, FR-E10): 1분 주기 임시 스냅샷이 저장되고, 재진입 시 임시본이 최신이면 복구 여부를 묻는다
- [x] **EDIT-12** (P1, FR-E11): 라이트/다크 테마와 split/에디터 전용/미리보기 전용 레이아웃을 전환할 수 있다
...
- [x] **DOC-04** (P1, FR-D4): 제목·본문·태그 검색이 동작한다 (NFC 정규화, pg_trgm)
...
- [x] **WS-03** (P1, FR-W3): 회원은 워크스페이스에 가입 신청할 수 있다
- [x] **WS-04** (P1, FR-W4): Owner·Admin은 가입 신청을 승인·거절할 수 있다
- [x] **WS-05** (P1, FR-W5/NFR-3.3): Owner·Admin은 회원을 검색해 초대 메일을 발송하고, 수락 링크(서명·일회성·만료)를 클릭한 회원은 EDITOR로 편입된다
