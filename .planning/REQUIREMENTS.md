...
- [ ] **EDIT-01** (P0, FR-E1): 헤딩 H1~H4·P 서식을 툴바/문법으로 적용할 수 있다 (ATX `#`~`####`)
...
- [ ] **EDIT-04** (P0, FR-E4): Blockquote·언어 지정 Code Block·HR을 삽입할 수 있다
- [ ] **EDIT-05** (P0, FR-E5): Link·Image·Table(GFM)을 삽입할 수 있다
...
- [ ] **TREE-02** (P0, FR-T2/NFR-1.3): 폴더 계층은 Closure Table로 저장되고 서브트리 조회가 단일 쿼리로 수행된다
- [ ] **TREE-03** (P0, FR-T3): 폴더 생성·이름 변경·이동·소프트 삭제가 동작한다. 자기 자손으로의 이동은 거부된다

### Documents (DOC)

- [ ] **DOC-01** (P0, FR-D1): 문서 생성·수정·삭제가 동작하고, 삭제는 소프트 삭제로 즉시 휴지통에 나타난다
- [ ] **DOC-02** (P0, FR-D2/PRD §2-2·2-3): 휴지통에서 복원(cascade, 원위치 또는 루트)과 완전 삭제(ADMIN 이상)가 동작한다
