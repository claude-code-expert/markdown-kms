# brand-draculatheme-fe7970 implementation handoff
...
- `fonts/manifest.json`
- `guide.md`
- `imagery/cover-0.webp`
- `imagery/hero-pro-illustration.svg`
- `imagery/photo-founder-zeno.webp`
- `imagery/product-ebook-cover.webp`
- `imagery/product-vscode-alucard.webp`
- `imagery/product-vscode-pro.webp`
- `logos/favicon-1.ico`
- `logos/header-inline.svg`
- `logos/hero-icon.svg`
- `logos/og-image-2.webp`
- `prefetch/material.md`
