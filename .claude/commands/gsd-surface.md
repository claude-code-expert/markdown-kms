...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/.gsd-surface.json`
(sibling to `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/skills`).
...
`/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/.gsd-surface.json`
Install profile marker: `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/.gsd-profile`
Skill dirs: `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/skills/gsd-*/`
Engine module: `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
