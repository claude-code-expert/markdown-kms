...
<required_reading>
Read `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
