...
**Verification depth scales with `asvs_level`** (see @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
