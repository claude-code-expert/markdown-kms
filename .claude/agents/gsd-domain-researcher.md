...
<required_reading>
Read `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
