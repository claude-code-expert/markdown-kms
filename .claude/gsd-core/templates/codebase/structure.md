...
- Usage: Reference from command with `@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
