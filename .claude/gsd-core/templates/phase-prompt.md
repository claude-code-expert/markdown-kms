...
<!-- For checkpoint task examples and patterns, see @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
