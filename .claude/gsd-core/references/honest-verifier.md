...
`@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).
