...
Read and follow `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
