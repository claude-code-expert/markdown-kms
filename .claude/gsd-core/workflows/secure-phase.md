...
```
Agent(
  prompt="Read /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/templates/SECURITY.md`
