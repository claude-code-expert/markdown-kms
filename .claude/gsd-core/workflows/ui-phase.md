...
```markdown
Read /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/agents/gsd-ui-checker.md for instructions.
...
@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
