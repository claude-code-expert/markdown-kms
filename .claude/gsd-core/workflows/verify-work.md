...
<template>
@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/workflows/diagnose-issues.md
