...
<required_reading>
@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/ai-frameworks.md
@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/agents/gsd-eval-planner.md for instructions.
