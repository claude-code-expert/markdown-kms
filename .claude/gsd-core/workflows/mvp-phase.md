...
<required_reading>
@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/user-story-template.md
@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/spidr-splitting.md
@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
