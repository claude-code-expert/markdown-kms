...
- **Global scope**: `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/notes/`)
...
2. Glob `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/notes/` — works in any directory
