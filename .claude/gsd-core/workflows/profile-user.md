...
Key references:
- @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/USER-PROFILE.md" "/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/CLAUDE.md
```
