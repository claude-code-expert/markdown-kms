...
ones). Reference: @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/templates/spec.md.
