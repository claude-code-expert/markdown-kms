...
INSTALL_JS_GLOBAL="/Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/codevillain/Claude-Code-Expert/markdown-kms/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
